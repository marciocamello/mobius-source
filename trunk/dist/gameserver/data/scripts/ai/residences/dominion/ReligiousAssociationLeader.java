...
import quests.Q00732_ProtectTheReligiousAssociationLeader;
...
public class ReligiousAssociationLeader extends SiegeGuardFighter
{
	...
	private class OnPlayerEnterListenerImpl implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
			...
			Quest q = QuestManager.getQuest(Q00732_ProtectTheReligiousAssociationLeader.class);
	...
	public void onEvtDead(Creature killer)
	{
		...
		for (Player player : GameObjectsStorage.getAllPlayersForIterate())
		{
			if (player.getEvent(DominionSiegeEvent.class) == siegeEvent)
			{
				...
				QuestState questState = player.getQuestState(Q00732_ProtectTheReligiousAssociationLeader.class);
				if (questState != null)
				{
