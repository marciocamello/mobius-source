 ...
 */
package events.TrickOfTransmutation;
 ...
 */
public final class TrickOfTransmutation extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	private static final Logger _log = LoggerFactory.getLogger(TrickOfTransmutation.class);
