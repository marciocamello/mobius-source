 ...
 */
public final class TeamVsTeamArena3 extends Functions implements ScriptFile, OnDeathListener, OnTeleportListener, OnPlayerExitListener
{
	private static final Logger _log = LoggerFactory.getLogger(TeamVsTeamArena3.class);
	
	/**
	 * @author Mobius
	 */
	private static class TvTArena3Impl extends TeamVsTeamTemplate
	{
		/**
	...
	public void startEvent()
	{
		...
		if (SetActive("TvT Arena 3", true))
		{
			...
			Announcements.getInstance().announceToAll("TvT Arena began EVENT 3.");
		}
		else
		{
	...
	public void stopEvent()
	{
		...
		if (SetActive("TvT Arena 3", false))
		{
			...
			Announcements.getInstance().announceToAll("TvT Arena 3 EVENT over.");
		}
		else
		{
