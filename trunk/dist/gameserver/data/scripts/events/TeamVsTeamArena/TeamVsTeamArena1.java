 ...
 */
public final class TeamVsTeamArena1 extends Functions implements ScriptFile, OnDeathListener, OnTeleportListener, OnPlayerExitListener
{
	private static final Logger _log = LoggerFactory.getLogger(TeamVsTeamArena1.class);
	
	/**
	 * @author Mobius
	 */
	private static class TvTArena1Impl extends TeamVsTeamTemplate
	{
		/**
	...
	private static TeamVsTeamTemplate _instance;
	
	/**
	 * Method getInstance.
	 * @return TvTTemplate
	 */
	public static TeamVsTeamTemplate getInstance()
	{
		if (_instance == null)
		{
	...
	public void startEvent()
	{
		...
		if (SetActive("TvT Arena 1", true))
		{
			...
			Announcements.getInstance().announceToAll("TvT Arena began EVENT 1.");
		}
		else
		{
	...
	public void stopEvent()
	{
		...
		if (SetActive("TvT Arena 1", false))
		{
			...
			Announcements.getInstance().announceToAll("TvT Arena 1 EVENT over.");
		}
		else
		{
