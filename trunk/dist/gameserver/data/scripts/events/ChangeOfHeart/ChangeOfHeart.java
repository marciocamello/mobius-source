 ...
 */
public final class ChangeOfHeart extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	private static final Logger _log = LoggerFactory.getLogger(ChangeOfHeart.class);
