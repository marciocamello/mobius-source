...
public class Q00373_SupplierOfReagents extends Quest implements ScriptFile
{
	...
	public String render_urn(QuestState st, String[] page)
	{
		...
		else
		{
			...
			if (amt == 0)
			{
				...
				html += "</table><center><a action=\"bypass -h Quest Q00373_SupplierOfReagents urn\">Back</a></center></body></html>";
			}
		}
