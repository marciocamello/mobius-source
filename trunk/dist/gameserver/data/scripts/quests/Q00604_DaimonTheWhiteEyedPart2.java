...
public class Q00604_DaimonTheWhiteEyedPart2 extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if (event.equalsIgnoreCase("31541-02.htm"))
		{
			...
			if ((ServerVariables.getLong(Q00604_DaimonTheWhiteEyedPart2.class.getSimpleName(), 0) + (3 * 60 * 60 * 1000)) > System.currentTimeMillis())
			{
				return "31541-05.htm";
			}
	...
	private static class DeathListener implements OnDeathListener
	{
		...
		{
			ServerVariables.set(Q00604_DaimonTheWhiteEyedPart2.class.getSimpleName(), String.valueOf(System.currentTimeMillis()));
		}
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if (cond == 2)
		{
			if (npcId == ALTAR)
			{
				...
				else if ((ServerVariables.getLong(Q00604_DaimonTheWhiteEyedPart2.class.getSimpleName(), 0) + (3 * 60 * 60 * 1000)) > System.currentTimeMillis())
				{
					htmltext = "31541-05.htm";
				}
				else
