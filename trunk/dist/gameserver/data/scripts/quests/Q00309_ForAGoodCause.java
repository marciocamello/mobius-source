...
public class Q00309_ForAGoodCause extends Quest implements ScriptFile
{
	@Override
	public void onLoad()
	{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if (npcId == Atra)
		{
			if (id == CREATED)
			{
				QuestState qs1 = st.getPlayer().getQuestState(Q00308_ReedFieldMaintenance.class);
			...
			else if (cond == 1)
			{
				...
				else if (!st.getPlayer().isQuestCompleted(Q00239_WontYouJoinUs.class))
				{
					return "32647-a1.htm";
				}
				else
