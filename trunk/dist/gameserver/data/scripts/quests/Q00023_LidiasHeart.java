...
public class Q00023_LidiasHeart extends Quest implements ScriptFile
{
	...
	private final int MapForestofDeadman = 7063;
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if (npcId == Innocentin)
		{
			if (cond == 0)
			{
				QuestState TragedyInVonHellmannForest = st.getPlayer().getQuestState(Q00022_TragedyInVonHellmannForest.class);
