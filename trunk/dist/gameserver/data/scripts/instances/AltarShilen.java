...
public class AltarShilen extends Reflection
{
	...
	Location NPC1Loc = new Location(179576, 13592, -7420);
	Location NPC2Loc = new Location(179576, 13592, -9852);
	Location KeyStage1Loc = new Location(179656, 18535, -8157);
	Location KeyStage2Loc = new Location(179656, 13528, -8157);
	Location Boss1Loc = new Location(178152, 14856, -8341, 16383);
	Location Boss2Loc = new Location(178152, 14856, -10768, 16383);
	Location End1Loc = new Location(178152, 13576, -8045);
	Location End2Loc = new Location(178152, 13576, -10476);
