...
public final class KartiaLabyrinth90Party extends Reflection
{
	...
	final int KartiaGuard = 19232;
	final int KartiaWatchman = 19233;
	final int DimensionalWatchman = 19234;
	final int LordOfKartia = 25883;
	...
	class StartKartiaParty90 extends RunnableImpl
	{
		StartKartiaParty90()
		{
		}
	...
	public class ZoneListener implements OnZoneEnterLeaveListener
	{
		...
		public void onZoneEnter(Zone zone, Creature cha)
		{
			...
			ThreadPoolManager.getInstance().schedule(new StartKartiaParty90(), 30000);
			_startLaunched = true;
		}
