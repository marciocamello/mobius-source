...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see lineage2.commons.util.Rnd#nextDouble()
		 */
		...
		/**
		 * Gets a random long number from 0(inclusive) to n(exclusive)
		 * @param tick The superior limit (exclusive)
		 * @return A random long number from 0 to n-1
		 */
		public final long get(final long tick)
		{
			return (long) (_random.nextDouble() * tick);
		}
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link lineage2.commons.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see lineage2.commons.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see lineage2.commons.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @return A random long number from 0 to n-1
	 */
	public static final long get(final long tick)
	{
		return rnd.get(tick);
	}
	 ...
	 * @param n
	 * @return
	 * @see lineage2.commons.util.Rnd#get(int n)
	 */
