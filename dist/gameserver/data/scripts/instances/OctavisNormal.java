...
public class OctavisNormal extends Reflection
{
	...
	CurrentHpListener _currentHpListenerFistsStage = new CurrentHpListener();
	CurrentHpListener _currentHpListenerOctavisRide = new CurrentHpListener();
	CurrentHpListener _currentHpListenerTwoStage = new CurrentHpListener();
