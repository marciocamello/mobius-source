...
import quests.Q00733_ProtectTheEconomicAssociationLeader;
...
public class EconomicAssociationLeader extends SiegeGuardFighter
{
	...
	private class OnPlayerEnterListenerImpl implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
			...
			Quest q = QuestManager.getQuest(Q00733_ProtectTheEconomicAssociationLeader.class);
	...
	public void onEvtDead(Creature killer)
	{
		...
		for (Player player : GameObjectsStorage.getAllPlayersForIterate())
		{
			if (player.getEvent(DominionSiegeEvent.class) == siegeEvent)
			{
				...
				QuestState questState = player.getQuestState(Q00733_ProtectTheEconomicAssociationLeader.class);
				if (questState != null)
				{
