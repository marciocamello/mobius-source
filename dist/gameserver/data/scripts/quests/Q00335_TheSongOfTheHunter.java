...
public class Q00335_TheSongOfTheHunter extends Quest implements ScriptFile
{
	// NPCs
	...
	private static String FormatList(QuestState st, Request[] requests)
	{
		...
		for (int i = 0; i <= 5; i++)
		{
			String s = "<a action=\"bypass -h Quest Q00335_TheSongOfTheHunter 30745-request-" + requests[listpacked[i]].request_id + "\">" + requests[listpacked[i]].text + "</a>";
