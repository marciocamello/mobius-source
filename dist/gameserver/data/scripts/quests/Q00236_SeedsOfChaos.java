...
public class Q00236_SeedsOfChaos extends Quest implements ScriptFile
{
	// NPCs
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if (_state == CREATED)
		{
			...
			if ((st.getPlayer().getQuestState(Q00234_FatesWhisper.class) != null) && st.getPlayer().getQuestState(Q00234_FatesWhisper.class).isCompleted())
			{
				st.setCond(0);
				return "32138_02.htm";
			}
