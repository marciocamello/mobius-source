...
public class Q00025_HidingBehindTheTruth extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState qs, NpcInstance npc)
	{
		if (event.equalsIgnoreCase("StartQuest"))
		{
			...
			QuestState qs_24 = qs.getPlayer().getQuestState(Q00024_InhabitantsOfTheForestOfTheDead.class);
