 ...
 * @author Smo
 */
public class Q00716_PathToBecomingALordRune extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if (npcId == Frederick)
		{
			...
			{
				QuestState hidingBehindTheTruth = st.getPlayer().getQuestState(Q00025_HidingBehindTheTruth.class);
				QuestState hiddenTruth = st.getPlayer().getQuestState(Q00021_HiddenTruth.class);
