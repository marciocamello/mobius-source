...
public class Q00610_MagicalPowerOfWaterPart2 extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if ((ServerVariables.getLong(Q00610_MagicalPowerOfWaterPart2.class.getSimpleName(), 0) + (3 * 60 * 60 * 1000)) > System.currentTimeMillis())
			{
	...
	private static class DeathListener implements OnDeathListener
	{
		...
		{
			ServerVariables.set(Q00610_MagicalPowerOfWaterPart2.class.getSimpleName(), String.valueOf(System.currentTimeMillis()));
		}
	}
