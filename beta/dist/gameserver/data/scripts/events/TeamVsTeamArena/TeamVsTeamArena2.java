 ...
 */
public final class TeamVsTeamArena2 extends Functions implements ScriptFile, OnDeathListener, OnTeleportListener, OnPlayerExitListener
{
	private static final Logger _log = LoggerFactory.getLogger(TeamVsTeamArena2.class);
	
	/**
	 * @author Mobius
	 */
	private static class TvTArena2Impl extends TeamVsTeamTemplate
	{
		/**
	...
	public void startEvent()
	{
		...
		if (SetActive("TvT Arena 2", true))
		{
			...
			Announcements.getInstance().announceToAll("TvT Arena began EVENT 2.");
		}
		else
		{
	...
	public void stopEvent()
	{
		...
		if (SetActive("TvT Arena 2", false))
		{
			...
			Announcements.getInstance().announceToAll("TvT Arena 2 EVENT over.");
		}
		else
		{
