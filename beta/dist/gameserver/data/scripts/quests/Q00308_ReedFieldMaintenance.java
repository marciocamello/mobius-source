...
public class Q00308_ReedFieldMaintenance extends Quest implements ScriptFile
{
	@Override
	public void onLoad()
	{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if (npcId == Katensa)
		{
			if (id == CREATED)
			{
				QuestState qs1 = st.getPlayer().getQuestState(Q00309_ForAGoodCause.class);
			...
			else if (cond == 1)
			{
				...
				else if (!st.getPlayer().isQuestCompleted(Q00238_SuccessFailureOfBusiness.class))
				{
					return "32646-a1.htm";
				}
				else
	...
	{
		st.rollAndGive(npc.getId() == ChangedMucrokian ? AwakenMucrokianHide : MucrokianHide, 1, 60);
		return null;
	}
}
