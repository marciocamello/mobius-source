 ...
 * @author Smo
 */
public class Q00714_PathToBecomingALordSchuttgart extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if (npcId == Newyear)
		{
			...
			{
				QuestState q1 = st.getPlayer().getQuestState(Q00114_ResurrectionOfAnOldManager.class);
				QuestState q2 = st.getPlayer().getQuestState(Q00120_PavelsLastResearch.class);
				QuestState q3 = st.getPlayer().getQuestState(Q00121_PavelTheGiant.class);
