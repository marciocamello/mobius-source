 ...
 * @author Mobius
 */
public final class TransformationSkillList implements IBypassHandler, ScriptFile
{
	/**
	 * Method getBypasses.
	 * @return String[]
	...
	public void onBypassFeedback(NpcInstance npc, Player player, String command)
	{
		...
		final Collection<SkillLearn> skills = SkillAcquireHolder.getInstance().getAvailableSkills(player, AcquireType.TRANSFORMATION);
		final AcquireSkillList asl = new AcquireSkillList(AcquireType.TRANSFORMATION, skills.size());
