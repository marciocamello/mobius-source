...
import quests.Q00729_ProtectTheTerritoryCatapult;
...
public class Catapult extends DefaultAI
{
	...
	private class OnPlayerEnterListenerImpl implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
			...
			Quest q = QuestManager.getQuest(Q00729_ProtectTheTerritoryCatapult.class);
		...
		if (first)
		{
			...
			for (Player player : GameObjectsStorage.getAllPlayersForIterate())
			{
				if (player.getEvent(DominionSiegeEvent.class) == siegeEvent)
				{
					...
					QuestState questState = player.getQuestState(Q00729_ProtectTheTerritoryCatapult.class);
					if (questState == null)
					{
