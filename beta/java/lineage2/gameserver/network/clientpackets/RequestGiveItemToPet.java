...
public class RequestGiveItemToPet extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (pet.isDead())
		{
			sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOUR_PET_IS_DEAD_AND_ANY_ATTEMPT_YOU_MAKE_TO_GIVE_IT_SOMETHING_GOES_UNRECOGNIZED));
			return;
		}
		...
		if (!item.getTemplate().isStackable() || (pet.getInventory().getItemByItemId(item.getId()) == null))
		{
			slots = 1;
		}
