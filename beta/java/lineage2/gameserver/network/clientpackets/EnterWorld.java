...
import lineage2.gameserver.network.serverpackets.ExAcquireAPSkillList;
...
import lineage2.gameserver.network.serverpackets.ExPeriodicHenna;
...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		activeChar.sendPacket(new MagicAndSkillList(activeChar));
		...
		// TODO: activeChar.sendPacket(new ExWaitWaitingSubStituteInfo(Config.PARTY_MATCHMAKING_ON_ENTERWORLD));
		...
		if (activeChar.getVar("startMovie") == null)
		{
			...
			{
				activeChar.sendPacket(new ExShowUsmVideo(ExShowUsmVideo.INTRO_2));
			}
		}
