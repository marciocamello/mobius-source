...
public final class SystemMessageId
{
	...
	@ClientString(id = 80, message = "Your title cannot exceed 16 characters in length.οΎ  Please try again.")
	...
	@ClientString(id = 94, message = "Copyright οΎ© NCSOFT Corporation. All Rights Reserved.")
	...
	@ClientString(id = 426, message = "Your account has been reported for not paying for your PC CafοΏ© usage.")
	...
	@ClientString(id = 547, message = "Summoning your petβ€¦")
	...
	@ClientString(id = 1079, message = "οΎ The target is currently banned from chatting.")
	...
	@ClientString(id = 1609, message = "War has already been declared against that clanβ€¦ but I'll make note that you really don't like them.")
	...
	@ClientString(id = 1623, message = "Make haste!  We will be departing for Gludin Harbor shortlyβ€¦")
	...
	@ClientString(id = 1628, message = "Make haste!  We will be departing for Gludin Harbor shortlyβ€¦")
	...
	@ClientString(id = 1655, message = "You've caughtβ€¦ Goldeen!")
	...
	@ClientString(id = 1873, message = "There are $s1 hour(s) and $s2 minute(s) left in the fixed use time for this PC CafοΏ©.")
	...
	@ClientString(id = 1875, message = "There are $s1 minute(s) left in the fixed use time for this PC CafοΏ©.")
	...
	@ClientString(id = 2030, message = "Logging inβ€¦")
	...
	@ClientString(id = 2044, message = "Some Lineage II features have been limited for free trials.οΎ Trial accounts aren't allowed to set up private workshops. To unlock all of the features of Lineage II, purchase the full version today.")
	...
	@ClientString(id = 2045, message = "Some Lineage II features have been limited for free trials.οΎ Trial accounts aren't allowed to use private workshops.οΎ To unlock all of the features of Lineage II, purchase the full version today.")
	...
	@ClientString(id = 2046, message = "Some Lineage II features have been limited for free trials.οΎ Trial accounts aren't allowed buy items from private stores.οΎ To unlock all of the features of Lineage II, purchase the full version today.")
	...
	@ClientString(id = 2047, message = "Some Lineage II features have been limited for free trials. Trial accounts aren't allowed to access clan warehouses.οΎ To unlock all of the features of Lineage II, purchase the full version today.")
	...
	@ClientString(id = 2284, message = "You have obtained all the points you can get today in a place other than Internet CafοΏ©.")
	...
	@ClientString(id = 3180, message = "No!οΎ  How could this be... You are but mere mortals?!")
	...
	@ClientString(id = 3184, message = "To die this way... Such a shameful defeat... Sirra... How could you do this to meβ€¦")
	...
	@ClientString(id = 3187, message = "Oh, this feeling. So familiarβ€¦now all this power is mine!")
	...
	@ClientString(id = 3190, message = "How dare you ignore my warning... Foolish creatures.οΎ Hahaha...")
	...
	@ClientString(id = 3193, message = "How dare you enter my castle!οΎ Hahaha... Foolish ones... Leave this place before the frost chills your blood.")
	...
	@ClientString(id = 3194, message = "Hmph!οΎ You will not dodge my blizzard again!")
	...
	@ClientString(id = 3238, message = "Are youβ€¦ Jude van Etina? This can't be!")
	...
	@ClientString(id = 3248, message = "Yes... You're doing wellβ€¦")
	public static SystemMessageId YES_YOU_RE_DOING_WELL;
	
	@ClientString(id = 3249, message = "I don't know what you are talking aboutβ€¦")
	...
	@ClientString(id = 3546, message = "How long has it been since I've had a visitorβ€¦?")
	...
	@ClientString(id = 3548, message = "Learn now from me about the tragic pastβ€¦filled with agony, sorrowβ€¦")
	public static SystemMessageId LEARN_NOW_FROM_ME_ABOUT_THE_TRAGIC_PAST_FILLED_WITH_AGONY_SORROW;
	
	@ClientString(id = 3549, message = "β€¦and  learn about the heartless witch that you worship as a goddess! Hahaβ€¦")
	...
	@ClientString(id = 3551, message = "We defied herβ€¦urghh!")
	...
	@ClientString(id = 3554, message = "It doesn't matter either wayβ€¦as long as you listen to me.")
	...
	@ClientString(id = 3557, message = "Betray the goddess, and plunge into the depths of hellβ€¦")
	...
	@ClientString(id = 3561, message = "Leave this placeβ€¦")
	public static SystemMessageId LEAVE_THIS_PLACE;
	
	@ClientString(id = 3562, message = "Beforeβ€¦before your light is tainted by the darkβ€¦")
	...
	@ClientString(id = 3576, message = "Hahaβ€¦")
	...
	@ClientString(id = 3580, message = "Kyaaaaa...Hyaaaaaβ€¦ Hayah!")
	public static SystemMessageId KYAAAAA_HYAAAAA_HAYAH;
	
	@ClientString(id = 3581, message = "Hahahaβ€¦ Defeat wasn't part of my plan. But, it doesn't matter... My research is almost completeβ€¦")
	public static SystemMessageId HAHAHA_DEFEAT_WASN_T_PART_OF_MY_PLAN_BUT_IT_DOESN_T_MATTER_MY_RESEARCH_IS_ALMOST_COMPLETE;
	
	@ClientString(id = 3582, message = "I have done it allβ€¦ for the glory of our goddessβ€¦")
	public static SystemMessageId I_HAVE_DONE_IT_ALL_FOR_THE_GLORY_OF_OUR_GODDESS;
	
	@ClientString(id = 3583, message = "For her... I welcome death...οΎ οΎ ")
	...
	@ClientString(id = 3592, message = "Howβ€¦how can this be? How can you allow my destruction, Shilen? No, my goddess, no!")
	...
	@ClientString(id = 3599, message = "Thanks to the efforts of valiant heroes, Baylor fellβ€¦")
	...
	@ClientString(id = 3603, message = "We must vanquish this new wardenβ€¦")
	...
	@ClientString(id = 3611, message = "Youβ€”you fool.")
	...
	@ClientString(id = 3629, message = "Behold the monster sent by your so-called goddess as her assassin.οΎ ")
	...
	@ClientString(id = 3634, message = "The forces of light are losing power. Before the world entire is engulfed in darknessβ€¦")
	...
	@ClientString(id = 3638, message = "I...I await you here. Hurryβ€¦find me.")
	...
	@ClientString(id = 3649, message = "Hahahahaβ€¦")
	...
	@ClientString(id = 3757, message = "Darkness spreadsβ€¦ contaminating even my waters' energy...")
	public static SystemMessageId DARKNESS_SPREADS_CONTAMINATING_EVEN_MY_WATERS_ENERGY;
	
	@ClientString(id = 3758, message = "Please, brave warriorsβ€¦ help meβ€¦")
	...
	@ClientString(id = 3760, message = "You brave fewβ€¦ who have answered my callβ€¦")
	...
	@ClientString(id = 3806, message = "Lots of things disappearedβ€¦ and died due to the resurrection of darkness.")
	...
	@ClientString(id = 3835, message = "Summoning $s1β€¦")
	...
	@ClientString(id = 4022, message = "Restoring appearanceβ€¦")
	...
	@ClientString(id = 4024, message = "Requesting purchaseβ€¦")
	...
	@ClientString(id = 4284, message = "The High Priest has repeatedly attempted to reach Lord Sayhaβ€¦")
	...
	@ClientString(id = 4295, message = "My childrenβ€¦beware the influence of darkness.")
	...
	@ClientString(id = 4302, message = "You can only create 1 character, and youβ€™ll be able to create additional characters after the maintenance on 5/28. The wait time to delete a character is 3 minutes.")
	...
	@ClientString(id = 5070, message = "(font size='15' color='#FFDF5F')The Lineage II server has been restructured as of 06/11/14.(/font)(br)(font size='13' color='#ABABAB')Bartz, Fehyshar(/font) β†’ Bartz(New)(br)(font size='13' color='#ABABAB')Erica, Gustin, Teon(/font) β†’ Sieghardt(New)(br)(font size='13' color='#ABABAB')Franz, Irene, Aria(/font) β†’ Kain(New)")
	...
	@ClientString(id = 6161, message = "Calculating XP and SP obtained from trainingβ€¦")
	...
	{
		return "SystemMessage[" + getId() + ":" + getName() + "]";
	}
}
