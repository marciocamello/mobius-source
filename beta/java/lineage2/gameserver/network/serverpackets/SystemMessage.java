...
public class SystemMessage extends L2GameServerPacket
{
	...
	private static final int TYPE_LONG_NUMBER = 6;
	private static final int TYPE_CASTLE_NAME = 5;
	private static final int TYPE_SKILL_NAME = 4;
	private static final int TYPE_ITEM_NAME = 3;
	private static final int TYPE_NPC_NAME = 2;
	private static final int TYPE_INT_NUMBER = 1;
	...
	public static final int THE_LEVEL_S1_SHILENS_BREATH_WILL_BE_ASSESSED = 1916;
	public static final int THE_SHILENS_BREATH_HAS_BEEN_LIFTED = 1917;
	...
	public static final int YOU_CANNOT_MAKE_ANOTHER_REQUEST_FOR_10_SECONDS_AFTER_CANCELLING_A_MATCH_REGISTRATION = 2707;
	public static final int YOU_CANNOT_REGISTER_WHILE_POSSESSING_A_CURSED_WEAPON = 2708;
	public static final int APPLICANTS_FOR_THE_OLYMPIAD_UNDERGROUND_COLISEUM_OR_KRATEI_S_CUBE_MATCHES_CANNOT_REGISTER = 2709;
	public static final int CURRENT_LOCATION__S1_S2_S3_NEAR_THE_KEUCEREUS_CLAN_ASSOCIATION_LOCATION = 2710;
	public static final int CURRENT_LOCATION__S1_S2_S3_INSIDE_THE_SEED_OF_INFINITY = 2711;
	public static final int CURRENT_LOCATION__S1_S2_S3_OUTSIDE_THE_SEED_OF_INFINITY = 2712;
	...
	public static final int SHOUT_AND_TRADE_CHATTING_CANNOT_BE_USED_WHILE_POSSESSING_A_CURSED_WEAPON = 2085;
	...
	public static final int C1_HAS_GIVEN_C2_DAMAGE_OF_S3 = 2261;
	public static final int C1_HAS_RECEIVED_DAMAGE_OF_S3_FROM_C2 = 2262;
	public static final int C1_HAS_RECEIVED_DAMAGE_OF_S3_THROUGH_C2 = 2263;
	public static final int C1_HAS_EVADED_C2S_ATTACK = 2264;
	public static final int C1S_ATTACK_WENT_ASTRAY = 2265;
	public static final int C1_HAD_A_CRITICAL_HIT = 2266;
	public static final int C1_RESISTED_C2S_DRAIN = 2267;
	public static final int C1S_ATTACK_FAILED = 2268;
	public static final int C1_RESISTED_C2S_MAGIC = 2269;
	public static final int C1_HAS_RECEIVED_DAMAGE_FROM_S2_THROUGH_THE_FIRE_OF_MAGIC = 2270;
	public static final int C1_WEAKLY_RESISTED_C2S_MAGIC = 2271;
	public static final int DAMAGE_IS_DECREASED_BECAUSE_C1_RESISTED_AGAINST_C2S_MAGIC = 2280;
	public static final int THERE_ARE_S2_SECONDS_REMAINING_IN_S1S_REUSE_TIME = 2303;
	public static final int THERE_ARE_S2_MINUTES_S3_SECONDS_REMAINING_IN_S1S_REUSE_TIME = 2304;
	public static final int THERE_ARE_S2_HOURS_S3_MINUTES_AND_S4_SECONDS_REMAINING_IN_S1S_REUSE_TIME = 2305;
	...
	public static final int ONLY_THE_CLAN_LEADER_OR_SOMEONE_WITH_RANK_MANAGEMENT_AUTHORITY_MAY_REGISTER_THE_CLAN = 4031;
	public static final int YOU_MAY_APPLY_FOR_ENTRY_AFTER_S1_MINUTE_S_DUE_TO_CANCELLING_YOUR_APPLICATION = 4038;
	public static final int ENTRY_APPLICATION_COMPLETE_USE_ENTRY_APPLICATION_INFO_TO_CHECK_OR_CANCEL_YOUR_APPLICATION_APPLICATION_IS_AUTOMATICALLY_CANCELLED_AFTER_30_DAYS_IF_YOU_CANCEL_APPLICATION_YOU_CANNOT_APPLY_AGAIN_FOR_5_MINUTES = 4039;
	public static final int ENTRY_APPLICATION_CANCELLED_YOU_MAY_APPLY_TO_A_NEW_CLAN_AFTER_5_MINUTES = 4040;
	public static final int THE_CLAN_YOU_SELECTED_IS_NO_LONGER_TAKING_APPLICATIONS_AS_IT_HAS_TOO_MANY_APPLICANTS = 4041;
	public static final int S1_S_CLAN_ENTRY_APPLICATION_HAS_BEEN_REJECTED = 4042;
	public static final int ENTERED_INTO_WAITING_LIST_NAME_IS_AUTOMATICALLY_DELETED_AFTER_30_DAYS_IF_DELETE_FROM_WAITING_LIST_IS_USED_YOU_CANNOT_ENTER_NAMES_INTO_THE_WAITING_LIST_FOR_5_MINUTES = 4043;
	public static final int YOU_MAY_ENTER_NAMES_INTO_THE_WAITING_LIST_AFTER_S1_MINUTE_S_DUE_TO_DELETING_FROM_THE_WAITING_LIST = 4044;
	...
	public static final int YOU_CAN_USE_THE_WORLD_CHAT_S1_TIMES = 4238;
	public static final int TODAY_YOU_REACHED_THE_LIMIT_OF_USE_OF_THE_WORLD_CHAT__RESET_OF_THE_WORLD_USE_CHAT_IS_DONE_DAILY_AT_6_30_AM = 4239;
	public static final int YOU_CAN_USE_THE_WORLD_CHAT_WITH_S1_LEVEL = 4240;
	...
	{
		args.add(new Arg(TYPE_INT_NUMBER, number));
		return this;
	}
	
	public SystemMessage addNumber(long number)
	{
		args.add(new Arg(TYPE_LONG_NUMBER, number));
		return this;
	}
	
	/**
	 * Sets the name if it's playable or if npc id
	 * @param cha
	 * @return
	 */
	...
	public SystemMessage addItemName(int id)
	{
		...
		// args.add(new Arg(TYPE_ITEM_NAME, item.getName()));
		args.add(new Arg(TYPE_ITEM_NAME, id));
		return this;
	}
	
	/*
	 * public SystemMessage addItemName(ItemInstance item) { return addItemName(item.getId()); } public SystemMessage addItemName(final ItemInfo item) { return addItemName(item.getId()); }
	 */
