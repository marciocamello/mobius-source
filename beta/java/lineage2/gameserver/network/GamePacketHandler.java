			...
			case IN_GAME:
				switch (opcode)
				{
					...
					case 0x31:
						...
						break;
					case 0x32:
						_log.info("msg = new AttackRequest();");
						break;
					case 0x33:
					...
					case 0x35:
						...
						_log.info("ChangeMoveTypePacket");
						break;
					case 0x36:
						// msg = new ChangeWaitType2();
						_log.info("ChangeWaitTypePacket");
						break;
					case 0x37:
					...
					case 0xc8:
						...
						_log.info("msg = new RequestSSQStatus();");
						break;
					case 0xc9:
					...
					case 0xd0:
						...
						switch (id2)
						{
							...
							case 0x31:
								...
								break;
							/*
							 * not used and delete case 0x32: msg = new RequestExEnchantSkillSafe(); break; case 0x33: msg = new RequestExEnchantSkillUntrain(); break; case 0x34: msg = new RequestExEnchantSkillRouteChange(); break;
							 */
							case 0x32: // 603
								msg = new RequestEnchantItemAttribute();
								break;
							/*
							 * not exist case 0x36: msg = new ExGetOnAirShip(); break;
							 */
							case 0x35: // 603
							...
							case 0x54: // 603
								...
								_log.info("RequestJoinDominionWar");
								break;
							case 0x55: // 603
								// msg = new RequestDominionInfo();
								_log.info("RequestDominionInfo");
								break;
							case 0x56: // 603
								// RequestExCleftEnter
								break;
							...
							case 0xac:
								...
								_log.info("RequestFirstPlayStart");
								break;
							case 0xae: // 603
