...
public enum ClassId
{
	...
	ERTHEIA_FIGHTER(182, ClassType.FIGHTER, Race.ertheia, null, ClassLevel.Initial, null),
	ERTHEIA_WIZARD(183, ClassType.MYSTIC, Race.ertheia, null, ClassLevel.Initial, null),
	MARAUDER(184, ClassType.FIGHTER, Race.ertheia, ERTHEIA_FIGHTER, ClassLevel.First, null),
	CLOUD_BREAKER(185, ClassType.PRIEST, Race.ertheia, ERTHEIA_WIZARD, ClassLevel.First, null),
	RIPPER(186, ClassType.FIGHTER, Race.ertheia, MARAUDER, ClassLevel.Second, null),
	STRATOMANCER(187, ClassType.MYSTIC, Race.ertheia, CLOUD_BREAKER, ClassLevel.Second, null),
	EVISCERATOR(188, ClassType.FIGHTER, Race.ertheia, RIPPER, ClassLevel.Third, null),
	SAYHASEER(189, ClassType.MYSTIC, Race.ertheia, STRATOMANCER, ClassLevel.Third, null);
